---
{"dg-publish":true,"permalink":"/improve-improv/stay-in-touch/","noteIcon":""}
---
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Cki-J5CLlko1320yE8hgpw.jpeg)
...
- **Trouble:** What is the specific symptom or gap between where you are and where you want to be?
- **Owner:** Who has the power to make the final decision? (Usually you, but acknowledge the role).
- **Success Criteria:** What does a “win” look like in measurable terms? (e.g., “Restore 5% revenue growth”).
- **Constraints:** What are the limits? (Budget, time, tech stacks, or legal hurdles).
- **Actors:** Who are the stakeholders who can influence the outcome or are affected by it?
...
- **Mutually Exclusive:** Your branches shouldn’t double-count issues.
- **Collectively Exhaustive:** You haven’t left any logical stones unturned.
...
- **The Key Line:** State your main recommendation or value prop immediately.
- **The Support:** Provide 3–5 logical arguments that prove your recommendation is correct.
- **The Data:** Provide the evidence only when the reader is already hooked.
